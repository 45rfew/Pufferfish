...
model =
  ...
  bodies:
    ...
    reactor2:
      ...
      position:
        x: [0,0,0,0,0,0,0,0]
        y: [-10,-10,11,22,22.1,20.1,20,20]
        z: [0,0,0,-4,-4,-4,-4,-4]
      width: [0,30,30,13,11,10,8,0].div(1.43)
      height: [0,40,40,23-5,18-3.3,18-3,16-4,0].div(1.7)
    ...
    hexagon:
      ...
      position:
        ...
        y: [0,0,2.5,2.5,0]
        z: [0,0,0,0,0]
      width: [3,4,4,3,3].mult(1.8)
      height: [3,4,4,3,3].mult(2)
      texture: [17] 
    hexagon2:
      section_segments: 6
      offset:
